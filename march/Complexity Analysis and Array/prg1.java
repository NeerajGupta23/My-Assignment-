...
// so => each level of tree will contribute n complexity and it goes till log(base 2)n so this series is AP so sum is total_length*(first_element + last_element)/2 => log(base 2)n*(n+n)/2 => n*log(base 2)n
